    ...
    <>
      ...
      <header className="frame fixed top-6 left-0 right-0 z-50 px-6 flex-col items-start max-md:items-center justify-between pointer-events-none">
        ...
        <div className="flex flex-col gap-2  max-md:gap-4 pointer-events-auto">
          ...
          <div className="flex gap-4 text-s max-md:justify-center font-mono">
            {articleUrl && (
              <a href={articleUrl} target="_blank" className="hover:underline">
                [GH]
              </a>
            )}
            {githubUrl && (
            ...
            {hubUrl && (
              <a href={hubUrl} target="_blank" className="hover:underline">
                [X]
              </a>
            )}
          </div>
